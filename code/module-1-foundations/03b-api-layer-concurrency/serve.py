...
def metrics_route():
    ...
    return {
        ...
        # real now, not a placeholder: LitServe's own dispatch queue, summed
...
if __name__ == "__main__":
    ...
    ap.add_argument("--workers", type=int, default=1,
                    help="worker processes on this one GPU (Lecture 03 used 1)")
    args = ap.parse_args()
    ...
    # counter, summed across however many workers we start below.
